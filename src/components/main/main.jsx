    ...
    <>
      ...
      <main className="page-main">
        ...
        <section className="filter">
          ...
          <form className="filter__form" method="post" action="#">
          ...
          <div className="characters__wrapper">
            <ul className="characters__list">
              <li className="characters__item">
                <img src="https://rickandmortyapi.com/api/character/avatar/361.jpeg" alt="Character image" width="150" height="150"/>
                <p className="characters__description">Rick from Earth</p>
              </li>
              <li className="characters__item">
                <img src="https://rickandmortyapi.com/api/character/avatar/361.jpeg" alt="Character image" width="150" height="150"/>
                <p className="characters__description">Rick from Earth</p>
        ...
        <div className="page-footer__wrapper">
          ...
          <ul className="page-footer__social-list">
            <li className="page-footer__social-item">
              <Link className="page-footer__social-link" to='https://github.com/VioletNeon'>
                <span className="visually-hidden">VioletNeon Git Hub</span>
                <svg className="page-footer__social-link-logo" width="25" height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 260">
                  <path d="M128 0a128 128 0 0 0-40 249c6 2 8-2 8-6v-24c-36 8-43-15-43-15-6-14-14-18-14-18-12-8 1-8 1-8 12 1 19 13 19 13 12 20 30 14 38 11 1-9 4-14 8-17-29-4-59-15-59-64 0-14 5-25 14-34-2-3-6-16 1-34 0 0 11-3 35 13a123 123 0 0 1 64 0c24-16 35-13 35-13 7 18 3 31 1 34 9 9 14 20 14 34 0 49-30 60-59 63 5 4 9 12 9 24v35c0 4 2 8 9 6A128 128 0 0 0 128 0ZM48 182l-2 1-1-2 2-1 1 2Zm6 6-2-1-1-2h3v3Zm5 7c-1 1-3 0-3-1v-3c1-1 2 0 3 1v3Zm7 8h-3c-2-1-2-3-1-3h3l1 3Zm9 3c0 1-1 2-3 1l-2-2c0-1 2-2 3-1 2 0 3 1 2 2Zm11 1c0 2-1 2-3 2l-2-1c0-2 1-2 2-2l3 1Zm11 0c0 1-1 2-3 2-1 1-3 0-3-1s1-2 3-2c1-1 2 0 3 1Z" fill="#ffffff"/>
                </svg>
              </Link>
            </li>
            <li className="page-footer__social-item">
              <Link className="page-footer__social-link" to='https://elfsight.com'>
                <span className="visually-hidden">Elfsight</span>
                <svg className="page-footer__social-link-logo" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#ffffff" viewBox="0 0 308 293">
                  <path d="M133 1c-8 2-12 7-12 15 0 9 5 13 17 13h22l22 1a119 119 0 0 1 94 138 119 119 0 0 1-138 94 119 119 0 0 1-95-121l-1-20c-3-4-7-7-13-7s-10 3-13 9c-2 4-2 5-2 23 0 16 0 21 2 30a148 148 0 0 0 284 18c6-19 7-25 7-49-1-19-1-23-3-31-7-30-19-51-40-72S217 7 189 1h-56z"/>
                  <path d="M2 16c-2 2-2 3-2 6 1 5-6-1 66 62l44 39c6 9 8 14 9 27l4 16c5 11 11 15 36 28l25 11 5-2 3-2v-38c0-35-1-39-2-44-3-7-9-15-15-19-8-6-164-86-168-86l-5 2z"/>
                </svg>
              </Link>
            </li>
            <li className="page-footer__social-item">
              <Link className="page-footer__social-link" to='https://rickandmortyapi.com'>
                <span className="visually-hidden">Rick and Morty API</span>
                <svg className="page-footer__social-link-logo" width="25" height="25" viewBox="0 0 50 50" fill="#ffffff">
